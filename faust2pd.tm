...
<\body>
  ...
  Get the latest source from <hlink|https://bitbucket.org/purelang/pure-lang/downloads/faust2pd-2.5.tar.gz|https://bitbucket.org/purelang/pure-lang/downloads/faust2pd-2.5.tar.gz>.
