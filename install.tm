...
<\body>
  ...
  using LLVM 3.4 and Pure 0.67, please substitute your actual version numbers
  ...
  You'll also need LLVM and, of course, Pure. The LLVM 3.4 and Pure 0.67
  tarballs are available here:

  <hlink|https://github.com/agraef/pure-lang/releases/download/pure-0.67/pure-0.67.tar.gz|https://github.com/agraef/pure-lang/releases/download/pure-0.67/pure-0.67.tar.gz>
  ...
  <\verbatim>
    ...
    $ tar xfvz pure-docs-0.67.tar.gz
  ...
  pure-docs-0.67.tar.gz tarball manually and then install the documentation
