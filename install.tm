...
<\body>
  ...
  using LLVM 3.4 and Pure 0.68, please substitute your actual version numbers
  ...
  You'll also need LLVM and, of course, Pure. The LLVM 3.4 and Pure 0.68
  tarballs are available here:

  <hlink|https://github.com/agraef/pure-lang/releases/download/pure-0.68/pure-0.68.tar.gz|https://github.com/agraef/pure-lang/releases/download/pure-0.68/pure-0.68.tar.gz>
  ...
  pure-docs-0.68.tar.gz tarball manually and then install the documentation
