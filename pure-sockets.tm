...
<\body>
  ...
  Get the latest source from <hlink|https://bitbucket.org/purelang/pure-lang/downloads/pure-sockets-0.6.tar.gz|https://bitbucket.org/purelang/pure-lang/downloads/pure-sockets-0.6.tar.gz>.
