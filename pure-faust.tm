...
<\body>
  ...
  Get the latest source from <hlink|https://bitbucket.org/purelang/pure-lang/downloads/pure-faust-0.9.tar.gz|https://bitbucket.org/purelang/pure-lang/downloads/pure-faust-0.9.tar.gz>.
